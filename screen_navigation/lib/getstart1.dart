        ...
        children: [
          ...
          Padding(
            ...
            child: ElevatedButton(
                ...
                child: const Text(
                    style: TextStyle(color: Colors.white), " Sign Up Screen3")),
          ),
          Padding(
            padding:
                const EdgeInsets.only(top: 20, bottom: 5, left: 10, right: 10),
          ...
          Padding(
            ...
            child: ElevatedButton(
                ...
                child: const Text(
                    style: TextStyle(color: Colors.white), "Setting Screen8")),
          ),
          Padding(
            padding:
                const EdgeInsets.only(top: 20, bottom: 5, left: 10, right: 10),
            child: ElevatedButton(
                ...
                child: const Text(
                    style: TextStyle(color: Colors.white), "Profile Screen8")),
          ),
        ],
      ),
    );
